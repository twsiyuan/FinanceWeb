...
<tr><th>',lang(31),'<td>',html_select("auth[driver]",$Xb,DRIVER,"loginDriver(this);"),'<tr><th>',lang(32),'<td><input name="auth[server]" value="finance.cd0esl2fpzqa.ap-northeast-1.rds.amazonaws.com" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
...
<tr><th>',lang(35),'<td><input name="auth[db]" value="finance',h($_GET["db"]);?>" autocapitalize="off">
</table>
